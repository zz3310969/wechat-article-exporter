<template>
  <div
    class="flex flex-col items-center relative mt-10 w-fit mx-auto login__type__container login__type__container__scan"
  >
    <h2 class="text-center text-2xl mb-5">登录微信公众平台</h2>
    <img
      :src="
        qrcodeSrc ||
        'https://res.wx.qq.com/mpres/zh_CN/htmledition/pages/login/loginpage/images/default_qrcode_2x6f3177.png'
      "
      alt=""
      class="block w-2/3 login__type__container__scan__qrcode"
    />
    ...
    <div class="login__type__container__scan__info">
      ...
      <!-- 没有可登录账号 -->
      <div
        class="login__type__container__scan__info__inner login__type__container__scan__noaccount"
        v-else-if="scanLoginType === 3"
      >
        <div class="login__type__container__scan_mask">
          <div class="login__type__container__scan_mask__inner">
        ...
        <p class="login__type__container__scan__info__desc">
          该微信还未注册公众平台账号，<a href="https://mp.weixin.qq.com/cgi-bin/registermidpage?action=index&lang=zh_CN"
            >现在去注册</a
          >
        </p>
        <a href="javascript:;" @click="refreshQrcode">重新扫码</a>
...
async function bizLogin() {
  ...
  if (result.err) {
    ...
    navigateTo('/dashboard/account', { replace: true });
  } else {
...
.login__type__container__scan
  ...
  .weui-desktop-icon.weui-desktop-icon__large.weui-desktop-icon__normal,
.login__type__container__scan
  .login__type__container__scan_mask
  .weui-desktop-icon.weui-desktop-icon__large.weui-desktop-icon.weui-desktop-icon__success,
.login__type__container__scan
  .login__type__container__scan_mask
  .weui-desktop-icon.weui-desktop-icon__large.weui-desktop-icon.weui-desktop-icon__warnning,
.login__type__container__scan
  .login__type__container__scan_mask
  .weui-desktop-icon.weui-desktop-icon__large.weui-desktop-icon.weui-desktop-icon__info,
.login__type__container__scan
  .login__type__container__scan_mask
